                        ...
                        <form method="post" action=""  id="brandForm" name="brandForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="name">Ime brenda</label>
                                        <input type="text" name="name" value="{{ $brands->name}}"  class="form-control" id="name">
                                        <p></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-8 mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{ $brands->slug }}" readonly name="slug" class="form-control text-lowercase" id="slug" >
                                        <p></p>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-start">   
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <label class="form-label" for="status">{{ $brands->name }} logo</label>
                                    <div class="py-2 mb-3" style="max-width:300px;">
                                        <img src="{{asset('uploads/brands/'.$brands->image) }}" class="img-fluid" style="height:auto; width:150px;">
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <option  {{ ($brands->status == 1) ? 'selected' : ''}} value="1">Aktivno</option>
                                        <option {{ ($brands->status == 0) ? 'selected' : ''}} value="0">Neaktivno</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="text-end">
                                ...
                                <a href="{{ route('brands.index')}}"  class="btn btn-sm btn-danger">Poništi</a>
                            </div>
                        </form>
                    </div>
                </div>               
