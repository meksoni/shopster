                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action=""  id="categoryForm" name="categoryForm">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-5 mb-3">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="name">Naziv kategorije<span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    <label class="form-label" for="showHome">Da li želite da prikažete kategoriju na početnoj?</label>
