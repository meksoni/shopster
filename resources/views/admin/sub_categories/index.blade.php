...
<div class="content pt-3 px-3 px-lg-6 d-flex flex-column-fluid">
    <div class="container-fluid position-relative px-0">
        ...
        <div class="d-flex mb-4 align-items-center">
            ...
            <h5 class="flex-shrink-0 mb-0 px-3">Lista Pod-kategorija</h5>
            <div class="flex-grow-1 border-top border-gray"></div>
        </div>
            ...
            <div class="col-12 mb-2">
                <div class="overflow-hidden card table-nowrap table-card">
                  ...
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="mb-0">
                        <button onclick="window.location.href='{{ route('sub-categories.index')}}'" type="reset" class="btn btn-secondary btn-sm">Refrešuj tabelu</button>
                    </div>
                        ...
                        @if ($subCategories->isNotEmpty())
                            @foreach ($subCategories as $subCategory)
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <a href="{{ $subCategory->categoryLink }}" class=" fs-6">
                                    ...
                                    <td class="text-end">
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="{{ route('sub-categories.edit', $subCategory->id)}}" class="dropdown-item">Izmeni</a>
                                                <a href="" onclick="deleteSubCategory({{ $subCategory->id }})" class="dropdown-item">Izbriši</a>
                                            </div>
                                        </div>
                                      </td>
                                </tr> 
