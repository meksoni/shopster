                        ...
                        <form method="post" action=""  id="subSubCategoryForm" name="subSubCategoryForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="name">Sub Sub Category Name</label>
                            ...
                            <div class="row">      
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="sub_category" name="subCategory">
                                        <option value="Izaberite..." selected >Izaberite...</option>
                                        <p></p>
                                    </select>
                                </div>
                            ...
                            <div class="text-end">
                                ...
                                <a href="{{ route('sub-sub-categories.index')}}"  class="btn btn-sm btn-danger">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>               
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    $("#subSubCategoryForm").submit(function(event){
        ...
        $.ajax({
            url: '{{ route("sub-sub-categories.store") }}',
            type: 'post',
    ...
    $("#category").change(function () {
        ...
        $.ajax({
            url: '{{ route("category-routes.index") }}',
            type: "get",
