            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        ...
                        <form method="post" action=""  id="subSubCategoryForm" name="subSubCategoryForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="name">Naziv podkategorije</label>
                                        <input type="text" name="name" value="{{$subSubCategory->name}}"  class="form-control" id="name">
                                        <p></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-8 mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" >/sub-sub-categories/</span>
                                        <input type="text" readonly value="{{$subSubCategory->slug}}" name="slug" class="form-control text-lowercase" id="slug" >
                                        <p></p>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12 mb-3">
                                    ...
                                    @if(!empty($subSubCategory->image))
                                    <div>
                                        <img src="{{asset('uploads/sub-categories/thumb/'.$subSubCategory->image) }}" width="150"  height="150">
                                    </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row">      
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="category" name="category">
                                        @foreach ($categories as $category)
                                            <option {{ ($subSubCategory->category_id == $category->id) ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="subCategory" name="subCategory">
                                        @foreach ($subCategories as $subCategory)
                                            <option {{ ($subSubCategory->sub_category_id == $subCategory->id) ? 'selected' : '' }} value="{{ $subCategory->id }}">{{ $subCategory->name }}</option>
                                        @endforeach
                                        <p></p>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <option  {{ ($subSubCategory->status == 1) ? 'selected' : ''}} value="1">Aktivno</option>
                                        <option {{ ($subSubCategory->status == 0) ? 'selected' : ''}} value="0">Neaktivno</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="text-end">
                                ...
                                <a href="{{ route('sub-sub-categories.index')}}" class="btn btn-sm btn-danger">Poništi</a>
                            </div>
                        </form>
                    </div>
                </div>               
...
<script>
    ...
    var element = $("#subSubCategoryForm");
    $("button[type=submit]").prop('disabled', true);

    $.ajax({
        url: '{{ route("sub-sub-categories.update",$subSubCategory->id) }}',
        type: 'put',
